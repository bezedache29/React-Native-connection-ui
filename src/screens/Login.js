import { View, Text, Platform, StyleSheet, Dimensions, TouchableOpacity, TextInput, StatusBar } from 'react-native'
      ...
      <Animatable.View animation="fadeInUpBig" style={styles.footer}>
        ...
        <View style={styles.button}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Register')} style={[styles.signIn, {borderColor: '#009387', borderWidth: 1, marginTop: 15}]}>
            <Text style={[styles.textSign, {color: '#009387'}]}>S'enregistrer</Text>
          </TouchableOpacity>
        </View>
      </Animatable.View>
    </View>
